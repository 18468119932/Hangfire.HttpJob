    ...
    public class DynamicJsDispatcher : IDashboardDispatcher
    {
        ...
        public Task Dispatch(DashboardContext context)
        {
            ...
            builder.Append(@"(function (hangFire) {")
                ...
                .AppendFormat("hangFire.httpjobConfig.UpdteRecurringJobHttpJobButtonName = '{0}';", _options.UpdteRecurringJobHttpJobButtonName)
                ...
                .AppendFormat("hangFire.httpjobConfig.JobDetailUrl = '{0}/httpjob?op=getdetailjobset';", context.Request.PathBase)
